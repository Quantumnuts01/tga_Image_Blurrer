    ...
    short Width, short Height)
{
    ...
    for (int y = StartHeightIndex; y < EndHeightIndex; y++)
    {
        for (int x = StartWidthIndex; x < EndWidthIndex; x++)
        {
            ...
            for (int iX = -((Width / 2) * BlurrAmmount); iX <= ((Width / 2) * BlurrAmmount); iX++)
            {
    ...
    for (int y = StartHeightIndex; y < EndHeightIndex; y++)
    {
        for (int x = StartWidthIndex; x < EndWidthIndex; x++)
        {
            ...
            int pixelsamples = 0;
            for (int iY = -((Height/2) * BlurrAmmount); iY <= ((Height/2) * BlurrAmmount); iY++)
            {
...
std::vector<RGBAPixel> ImageBlurrer::BlurrRGBAImage(std::vector<RGBAPixel> Image, short Width, short Height, float BlurrAmmount)
{
   ...
   // return Image;
    ...
    if (coresAvilable > 4)
    {
        ...
        int EndHeightIndex = Height - (Height / 2);
        int startWidthIndex = 0;
        int EndWidthIndex =  Width - (Width / 2);
        ...
        startHeightIndex = 0;
        EndHeightIndex = Height - (Height / 2);
